...
|---|---|---|---|---|---|---|---|
| xbook | hearth-care/auto-bookkeeper | `uv run xbook --agent-stdio` | `v0.3.0` | Yes | `assert_drives_clean` in `tests/cockpit/test_agent_contract.py` plus walk coverage in `tests/cockpit/test_agent_walk_coverage.py` | `9ea4648` · 2026-07-03 | On newer release tag than the supported baseline; accepted by the pin survey |
