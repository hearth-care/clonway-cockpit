...
> Survey source: `origin/main` of each worker repo, read 2026-07-02.
...
|---|---|---|---|---|---|---|---|
| xbook | hearth-care/auto-bookkeeper | `uv run xbook --agent-stdio` | `v0.2.0` | Yes | `assert_drives_clean` in `tests/cockpit/test_agent_contract.py` plus walk coverage in `tests/cockpit/test_agent_walk_coverage.py` | `91a980c` · 2026-07-02 | On newer release tag than the supported baseline; accepted by the pin survey |
