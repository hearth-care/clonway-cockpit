...
- Next concrete step: rebase onto `origin/main`, push with lease, mark the PR ready, move labels from `agent:claimed` to `agent:needs-qa`, and post the DONE comment.
